...
SYSTEM_PROMPT = (
    ...
    "Правила:\n"
    "- Фото должно быть релевантно сути новости.\n"
    ...
    "5. Если подходящих фото нет вообще — вызови select_images с пустым списком: публикация без фото это нормальный результат.\n"
)
